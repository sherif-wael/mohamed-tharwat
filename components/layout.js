...
function Layout({children}){
    return (
        <div>
            <Head>
                <meta name="description" content="دكتور محمد ثروت حجازى، أستاذ و استشاري الباطنة العامة و الروماتيزم و المناعة و التهاب الاوعية الدموية (م) كلية الطب- قصر العينى" />
